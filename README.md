...
[ipycodex](https://github.com/AnswerDotAI/ipycodex) is a sister project with the same interface but backed by the Codex app-server instead of litellm/Anthropic.
